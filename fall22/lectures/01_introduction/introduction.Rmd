...
```{r, out.width="75%"}
knitr::include_graphics("../images/all-models-wrong.jpg")
```
...
```{r, out.width="60%"}
knitr::include_graphics("../images/win_probability.png")
```
...
```{r, out.width="70%"}
knitr::include_graphics("../images/election_win_prob.png")
```
<center>source: fivethirtyeight.com</center>
...
knitr::include_graphics("../images/theory_of_probability.jpg")
```
