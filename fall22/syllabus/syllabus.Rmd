...
\noindent Professor Targino \url{rodrigotargino@ucsb.edu}: Office Hours, Fridays 3pm

\noindent Lauren Hughes \url{laurenhughes@ucsb.edu}: Office Hours, TBD

\noindent Yaqiao (Darcy) Wang \url{darcywang@ucsb.edu}: Office Hours, TBD

\noindent Cyril Wang \url{cyrilwang@ucsb.edu}: Office Hours, TBD
